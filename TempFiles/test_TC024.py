...
class Test_TC024:
    ...
    def test_purchase_button(self):
        ...
        if App_CustomerDetails.click_purchase_button(self.driver):
            log.info("User can click on Purchase button - " + self.getclassname() + " is PASSED")
        else:
            log.error("User can not click on Purchase button - " + self.getclassname() + " is FAILED")
